...
![**Điểm đáng chú ý**: khi bấm nút, GitHub hỏi muốn lấy code từ nhánh nào. File định nghĩa nút phải ở `main`, nhưng nút đó có thể chạy trên code của bất kỳ nhánh nào.](./image_step/3_3_dispatch_branch_selector.png)
